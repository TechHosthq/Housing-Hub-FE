...
export default function AdminCustomersPage() {
    ...
    return (
        <div className="flex flex-col gap-8" onClick={() => setOpenDropdownId(null)}>
            ...
            />
            <h1 className="text-[28px] font-bold text-[#1A1A1A] dark:text-gray-100 font-montserrat" onClick={(e) => e.stopPropagation()}>Manage Customers</h1>
            ...
            <div className="flex flex-col gap-4 w-full">
                {isLoading ? (
                    ...
                    const status = customer.isKycVerified ? "Verified" : (customer.kycSubmittedAt ? "Pending" : "Unverified");
                    return (
                        <div key={customer.id} className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[20px] p-6 shadow-sm hover:shadow-md transition-all group relative">
                            <div className="flex items-center gap-5">
                                ...
                                <div className="relative" onClick={(e) => e.stopPropagation()}>
                                    <button
                                        ...
                                        className={`p-2 rounded-full transition-colors ${openDropdownId === customer.id ? "bg-gray-100 dark:bg-gray-800 text-[#1A1A1A] dark:text-gray-100" : "text-gray-400 dark:text-gray-500 hover:text-[#1A1A1A] hover:bg-gray-50 dark:hover:bg-gray-800/50"}`}
                                    >
                                        <MoreVertical size={20} />
                                    </button>

                                    {openDropdownId === customer.id && (
                                        <div className="absolute top-full right-0 mt-2 w-[220px] bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[16px] shadow-xl py-2 z-50">
                                            <Link
