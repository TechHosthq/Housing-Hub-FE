    ...
    return (
        <div className="flex flex-col gap-8">
            ...
            <div className="flex items-center justify-between">
                <h1 className="text-[28px] font-bold text-[#1A1A1A] dark:text-gray-100 font-montserrat tracking-tight leading-none">
                    Property Management
                </h1>
                ...
                <div className="relative">
                    <button
                        ...
                        className="flex items-center gap-4 px-6 py-3 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[14px] shadow-sm hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-all group"
                    >
                        ...
                        <ChevronDown
                            size={18}
                            className={`text-gray-400 dark:text-gray-500 transition-transform duration-300 ${isFilterOpen ? "rotate-180" : ""}`}
                        />
                    </button>
                    {isFilterOpen && (
                        <div className="absolute top-full right-0 mt-2 w-48 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl shadow-lg py-2 z-10 animate-in fade-in zoom-in-95 duration-200">
                            {(isInspections ? ["All Inspections", "Approved", "Upcoming", "Pending"] : ["All properties", "Approved", "Pending", "Declined"]).map((option) => (
                                <button
                                    key={option}
                                    className="w-full text-left px-4 py-2.5 text-[14px] font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors"
            ...
            {/* Main Tabs */}
            <div className="flex bg-gray-50 dark:bg-gray-800/50 p-1.5 rounded-[12px] w-fit">
                <button
                    ...
                    className={`px-12 py-3 rounded-[10px] text-[13px] font-black transition-all ${activeTab === "LISTED PROPERTIES"
                        ? "bg-white dark:bg-gray-900 text-[#1A1A1A] dark:text-gray-100 shadow-sm"
                ...
                <div className="flex flex-col gap-4">
                    {MOCK_PROPERTIES.map((property) => (
                        <div
                            ...
                            className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[20px] p-6 flex flex-col sm:flex-row items-center gap-5 group hover:shadow-sm transition-all cursor-pointer relative"
                        >
                            {/* Thumbnail */}
                            <div className="w-full sm:w-[110px] h-[110px] rounded-[16px] bg-gray-100 dark:bg-gray-800 relative overflow-hidden flex-shrink-0">
                                <Image
                                    src={property.image}
                                    alt={property.title}
                                    fill
                            ...
                            <div className="flex flex-col gap-2 flex-1">
                                <div className="flex items-center gap-3">
                                    <h3 className="text-[22px] font-black text-[#1A1A1A] dark:text-gray-100 font-montserrat tracking-tight leading-none group-hover:text-[#0095FF] transition-colors">
                                        {property.title}
                                    </h3>
                                ...
                                <div className="flex items-center gap-4 text-[15px]">
                                    ...
                                    <span className="font-bold text-[#0095FF]">
                                        {property.status}: <span className="text-[#999999] dark:text-gray-500 font-medium">{property.date}</span>
                                    </span>
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                className="p-3 text-gray-300 hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-full transition-all flex-shrink-0 absolute top-6 right-6 sm:relative sm:top-auto sm:right-auto"
                            >
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-2 flex-1">
                                    ...
                                    <div className="flex items-center gap-4 text-[15px]">
                                        ...
                                        <span className="font-bold text-[#0095FF]">
                                            Requested: <span className="text-[#999999] dark:text-gray-500 font-medium">{inspection.date}</span>
                                        </span>
                                    </div>
                                </div>
