...
export default function ClientPagination({
    ...
    return (
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-8 border-t border-gray-100 dark:border-gray-800 pt-8 animate-in fade-in duration-300">
            <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <p className="text-[13px] font-bold text-gray-400 dark:text-gray-500">
                    Showing <span className="text-[#1A1A1A] dark:text-gray-100">{totalCount > 0 ? startIndex + 1 : 0}</span> to{" "}
                    <span className="text-[#1A1A1A] dark:text-gray-100">
                        {Math.min(startIndex + pageSize, totalCount)}
                    </span>{" "}
                    of <span className="text-[#1A1A1A] dark:text-gray-100">{totalCount}</span> records
                </p>
            </div>
