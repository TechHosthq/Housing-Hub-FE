...
export default function Footer() {
    return (
        <footer className="bg-[#002B7F] text-white pt-24 pb-16 px-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-20 mb-16">
                ...
                <div>
                    <h4 className="font-bold text-xl mb-8 text-white">For Customers</h4>
                ...
                <div>
                    <h4 className="font-bold text-xl mb-8 text-white">For Homeowners</h4>
                    <ul className="space-y-4 text-white/70 text-base font-medium">
                ...
                <div>
                    <h4 className="font-bold text-xl mb-8 text-white">Support</h4>
                    <ul className="space-y-4 text-white/70 text-base font-medium">
