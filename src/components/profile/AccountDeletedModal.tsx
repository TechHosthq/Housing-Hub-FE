    ...
    return (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-[440px] bg-white dark:bg-gray-900 rounded-[32px] shadow-2xl p-12 flex flex-col items-center justify-center animate-in fade-in zoom-in duration-500">
                ...
                <h2 className="text-[28px] font-black text-[#1A1A1A] dark:text-gray-100 font-montserrat text-center">
                    Account Deleted!
                </h2>

                {/* Optional: Subtle redirect text */}
                <p className="text-[12px] text-gray-400 dark:text-gray-500 font-bold mt-4">
