    ...
    if (isLoading) {
        return (
            <section className="py-20 px-6 md:px-8 max-w-7xl mx-auto">
                <h2 className="text-3xl font-extrabold text-[#1A1A1A] dark:text-gray-100 mb-12 tracking-tight">Trending Properties</h2>
        ...
        <section className="py-20 px-6 md:px-8 max-w-7xl mx-auto">
            ...
            {allProperties.length === 0 && !isLoading && (
                <div className="text-center py-20 bg-gray-50 dark:bg-gray-800/50 rounded-[40px] border-2 border-dashed border-gray-200 dark:border-gray-800">
                    <p className="text-gray-400 dark:text-gray-500 text-xl font-medium">No trending properties found at the moment.</p>
                </div>
            )}
